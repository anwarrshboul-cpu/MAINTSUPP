...
/** The form itself; `page.tsx` resolves the session before it is drawn. */
  ...
  return (
    <main className="request-page">
      ...
      <section className="request-page__layout">
        {/* A <div>: the introduction to this page, not content beside it, and a
            complementary landmark nested in the page's own region is an axe fault. */}
