...
/**
 * Website media — decision K (§77 item 12).
 *
 ...
 * arrives with `app/api/cms-media/route.ts` and its upload route, gated on the
 * same `scope.platformAdmin` this route is.
 */
...
export default async function AdminSiteMediaPage() {
  const session = await requirePageSession("/admin/media");
